-- ========================================
-- VERSÃO SIMPLIFICADA - APENAS USER_PROFILES
-- ========================================
-- Esta versão funciona apenas com a tabela user_profiles
-- sem tentar acessar auth.users diretamente
-- ========================================
...
-- 2. Função simplificada para listar perfis de usuários
...
-- 4. Função para atualizar perfil de usuário
...
-- 5. Função para excluir perfil de usuário
