-- ========================================
-- CORREÇÃO FINAL - REMOVER FOREIGN KEY CONSTRAINT
-- ========================================
-- Este script remove a foreign key constraint que está causando o erro 409
-- ========================================
...
-- 2. Remover foreign key constraint da tabela user_profiles
...
-- 4. Função simplificada para listar perfis de usuários
...
-- 5. Função para criar perfil de usuário (SEM foreign key)
...
BEGIN
  ...
  -- Inserir perfil do usuário (SEM foreign key constraint)
