-- ========================================
-- SISTEMA SIMPLIFICADO E TESTADO
-- ========================================
...
DROP FUNCTION IF EXISTS create_user_automatically_by_admin(TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS update_user_profile_by_admin(UUID, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS delete_user_completely_by_admin(UUID);

-- 2. Garantir que a tabela user_profiles tem o campo email
ALTER TABLE public.user_profiles 
ADD COLUMN IF NOT EXISTS email TEXT;

-- 3. Função simples para listar usuários
...
-- 4. Função simples para criar usuário (apenas perfil por enquanto)
...
GRANT EXECUTE ON FUNCTION create_user_profile_simple(TEXT, TEXT, TEXT, TEXT) TO authenticated;
